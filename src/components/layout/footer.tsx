    ...
    <div>
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          required
          disabled={isLoading}
          className="flex-1 px-4 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder:text-white/50 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <button
          type="submit"
          disabled={isLoading}
          className="px-5 py-2 bg-white hover:bg-gray-100 text-gray-900 rounded-lg text-sm font-medium transition-colors disabled:opacity-50"
        >
          {isLoading ? '...' : 'Subscribe'}
        </button>
      </form>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              ...
              <li>
                <a href="https://www.dr-dede.com/retreats-advocacy" className="hover:text-purple-400 transition-colors duration-200 flex items-center gap-2 group">
                  <span className="w-1 h-1 bg-purple-400 rounded-full group-hover:w-2 transition-all duration-200" />
                  Luxury Retreats
                </a>
              </li>
              <li>
                <a href="https://www.dr-dede.com/speaking" className="hover:text-purple-400 transition-colors duration-200 flex items-center gap-2 group">
                  <span className="w-1 h-1 bg-purple-400 rounded-full group-hover:w-2 transition-all duration-200" />
                  Speaking & Events
                </a>
              </li>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              >
                <LinkedinIcon className="h-5 w-5 text-gray-300 group-hover:text-white transition-colors" />
              </a>
              <a
              ...
              <a
                ...
                rel="noopener noreferrer"
              >
                <InstagramIcon className="h-5 w-5 text-gray-300 group-hover:text-white transition-colors" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <FacebookIcon className="h-5 w-5 text-gray-300 group-hover:text-white transition-colors" />
              </a>
              <a
                ...
                rel="noopener noreferrer"
              >
                <BlueSkyIcon className="h-5 w-5 text-gray-300 group-hover:text-white transition-colors" />
              </a>
            </div>
          </div>
        </div>
