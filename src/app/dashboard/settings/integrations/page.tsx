...
export default function IntegrationsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-4xl font-bold text-gray-900">SIEM Integrations</h1>
        <p className="text-gray-600 mt-2">Connect your SIEM platforms for centralized event collection and monitoring</p>
      </div>
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-gray-900">Available SIEM Platforms</h2>
        </div>
        <button
      ...
      {showConfig === 'new' && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-lg max-w-md w-full mx-4">
            <div className="p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Add SIEM Integration</h3>

              <div className="space-y-4 mb-6">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">SIEM Platform</label>
                  <select
                    value={selectedType}
                    onChange={(e) => {
            ...
            >
              ...
              {connector ? (
                <div className="space-y-3 mt-4 pt-4 border-t border-gray-200">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-gray-600">Events Sent</span>
                    <span className="text-sm font-bold text-gray-900">{connector.eventsSent}</span>
                  </div>
                  ...
                  <div className="flex space-x-2 pt-3">
                    <button
                      ...
                      className="flex-1 px-3 py-2 border border-gray-300 text-gray-700 text-sm font-medium rounded hover:bg-gray-50 transition-colors disabled:opacity-50"
                    >
      ...
      {connectors.length > 0 && (
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Event Delivery Metrics</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-sm text-gray-600 mb-1">Total Connectors</p>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-sm text-gray-600 mb-1">Total Events Sent</p>
